    ...
    <section class="content">
        ...
        <div class="block-header">
                <center><div class="font-bold font-32">Laboratorium Kimia & Lingkungan </p>
                            ...
                            <form class="form-horizontal">
                                <div class="row">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="email_address_2">ID Produk</label>
                                    </div>
                                ...
                                <center>
                                <div class="form-group">
                                    <button type="submit" class="btn btn-success waves-effect">Simpan Data Produk</button>
                                </div>
                                <br>
                                </center>
                                    ...
                                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>$320,800</td>
                                                <td>
                                                <button class="btn btn-danger waves-effect">Delete</button></td>
                                            </tr>
                                            <tr>
