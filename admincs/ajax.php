...
$query = mysqli_query($koneksi, "SELECT p1.id_pendaftaran, p1.nama_produk, p1.jenis_produk, p1.rekomendasi_datang, p1.tanggal_pendaftaran, p2.asal_perusahaan from pendaftaran p1 JOIN pengunjung p2 ON p1.id_pendaftaran = p2.id_pengunjung WHERE p1.id_pendaftaran = '".$q."'");
